...
public class Constants {
    public static final Object ONBOARD_KEYCLOAK_USER = "/iamcontroller/onboard-kc-user";
    ...
    public static final String REMOVE_GROUP_ACCESS ="/iamcontroller/remove-group-access" ;
}
